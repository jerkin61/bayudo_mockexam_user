...
export const Item = ({ item, key }) => {
  return (
    <Reorder.Item
      className="score-item flex justify-start items-center self-stretch flex-grow relative overflow-hidden px-[12.360593795776367px] py-[1.426222324371338px] rounded-[9.09px] bg-[white]/90"
      id={item.user}
    >
      {" "}
...
const HomeScoreBoardList = ({ data }) => {
  ...
  return (
    <Reorder.Group
      className="score-container flex flex-col justify-start items-center self-stretch flex-grow overflow-hidden gap-[4.543269157409668px] px-[14.992788314819336px] py-[4.543269157409668px]"
      axis="y"
      values={items}
    >
      {items?.map((item) => {
