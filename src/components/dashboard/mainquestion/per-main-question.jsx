...
const PerMainQuestion = ({
  ...
  const checkAnswer = () => {
    if (selectedKey) {
      ...
      setErrorMsg(
        thisAnswer ? "You got it RIGHT" : "That's fine. Get it right next time."
      );
  ...
  return (
    <div className="per-main-question-container flex flex-col justify-between items-center p-[25px] lg:p-[100px] h-full flex justify-center items-center h-full overflow-x-scroll">
      <div className="flex flex-col lg:flex-row lg:gap-[60px] justify-start items-center self-stretch gap-[15px]">
        ...
        <div className="lg:w-[40%] w-full">
          ...
          {!lastPage && locked && !showComplate && (
            <button
              onClick={endOfReview}
              className="mt-6 last-page-button hidden  w-full bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded"
            >
              End of review
            </button>
          )}{" "}
