...
const ExamMainContainer = ({ item, index }) => {
  ...
  return (
    <div
      ...
      key={index}
      class="flex flex-col justify-start items-center self-stretch gap-[15px] py-2.5"
    >
      <div class="flex flex-col justify-center items-start self-stretch overflow-hidden gap-2.5 px-5 py-[15px] rounded-[5px] bg-white hover:bg-[#41b2f3]/50">
        <div class="flex justify-center items-center self-stretch relative gap-2.5 px-2.5">
          <div
          ...
          <div class="flex flex-col justify-center items-start flex-grow relative gap-2.5">
            <p class="text-xl font-semibold text-left text-[#222]">{name}</p>
            <p class="text-[15px] text-left text-[#727272]">
              <span class="text-[15px] text-left text-[#727272]">
        ...
        {closeOrOpen && (
          <div class="flex flex-col justify-start items-center self-stretch gap-2.5 pl-[50px] py-2.5">
            <div class="flex justify-between items-center self-stretch relative">
              <p class="w-full h-[19px] text-base font-bold text-left text-black">
