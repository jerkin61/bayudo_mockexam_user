...
const PerRandomQuestion = ({
  ...
  return (
    <div
      className="flex flex-col justify-between items-center p-[25px] h-full flex justify-center items-center h-full overflow-x-scroll lg:p-[100px]"
      ref={(ref) => {
        ...
        <div className="lg:w-[40%] w-full">
          ...
          {rightOrWrong === null && (
            <h2 className="text-white">
              {selectedKey
                ? "Click to lock choice."
                : "Select from the choice to proceed"}
            </h2>
          )}
          <button
            disabled={loadingMore || !selectedKey}
            ...
            style={{ cursor: (loadingMore || !selectedKey) && "not-allowed" }}
          >
